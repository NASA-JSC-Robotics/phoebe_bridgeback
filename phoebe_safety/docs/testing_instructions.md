...
The following is instructions to test the functionality of the safety manager node, and to help troubleshoot if need be. (Assuming you followed the build instructions from the overall phoebe_bridgeback README.md, and have the repo built.)
