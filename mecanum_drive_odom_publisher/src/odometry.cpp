...
bool Odometry::update(double wheel_front_left_vel, double wheel_back_left_vel, double wheel_back_right_vel,
                      double wheel_front_right_vel, const double dt)
{
  ...
  tf2::Vector3 linear_transformation_from_center_2_base =
      angular_transformation_from_center_2_base * tf2::Vector3(-base_frame_offset_[0], -base_frame_offset_[1], 0.0);

  velocity_in_base_frame_linear_x = velocity_in_center_frame_w_r_t_base_frame_.x() +
                                    linear_transformation_from_center_2_base.y() * velocity_in_center_frame_angular_z;
  velocity_in_base_frame_linear_y = velocity_in_center_frame_w_r_t_base_frame_.y() -
